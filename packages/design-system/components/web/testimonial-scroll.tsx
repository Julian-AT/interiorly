import { Marquee } from '@interiorly/design-system/components/ui/marquee';
    ...
    <div className="h-full">
      <div className="px-10">
        <div className="relative max-h-[750px] overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-1/6 w-full bg-gradient-to-t from-20% from-background md:h-1/5" />
          <div className="pointer-events-none absolute inset-x-0 top-0 h-1/6 w-full bg-gradient-to-b from-20% from-background md:h-1/5" />
        </div>
      </div>
    </div>
  );
