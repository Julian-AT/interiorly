...
import { colorWithOpacity, getRGBA } from '@interiorly/design-system/lib/utils';
...
export function NumberFlowCounter({
  ...
  return (
    <div
      ...
      } -translate-x-1/2 absolute top-32 left-[50%] flex h-8 items-center justify-center rounded-full border border-blue-400 bg-blue-600 px-4 py-1 font-mono text-sm text-white shadow-[0px_1.1px_0px_0px_rgba(255,255,255,0.20)_inset,0px_4.4px_6.6px_0px_rgba(255,255,255,0.01)_inset,0px_2.2px_6.6px_0px_rgba(18,43,105,0.04),0px_1.1px_2.2px_0px_rgba(18,43,105,0.08),0px_0px_0px_1.1px_rgba(18,43,105,0.08)] transition-opacity duration-300 ease-in-out dark:border-white/[0.07] dark:bg-[#1A1B25]`}
    >
      <NumberFlow
        value={currentValue}
        className="font-mono "
      ...
      />
      <span className="ml-2 text-sm">Minutes Saved</span>
    </div>
  );
}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="-translate-x-1/2 absolute top-[60%] left-1/2 h-32 w-[2px] bg-gradient-to-b from-[var(--color)] to-[var(--color-transparent)]"
      ></motion.div>
      <NumberFlowCounter
