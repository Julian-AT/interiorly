...
import { ThemeToggle } from '@interiorly/design-system/components/theme-toggle';
import { Icons } from '@interiorly/design-system/components/web/icons';
import { NavMenu } from '@interiorly/design-system/components/web/nav-menu';
        ...
        >
          <div className="flex h-[56px] items-center justify-between p-4">
            <Link href="/" className="flex items-center gap-3">
              ...
              <p className="font-semibold text-lg text-primary">Interiorly</p>
            </Link>
