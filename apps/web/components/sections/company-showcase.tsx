  ...
  return (
    ...
    >
      ...
      <div className="z-20 grid w-full max-w-7xl grid-cols-2 items-center justify-center overflow-hidden border-border border-y md:grid-cols-4">
        {companyShowcase.companyLogos.map(
          (logo) =>
            (
              <Link
						href="#"
						...
						key={logo.id}
					>
						<div className='0.84, 0.44, 1)] group-hover:-translate-y-4 flex h-full w-full translate-y-0 items-center justify-center transition-all duration-200 duration-300 [cubic-bezier(0.165,'>
							{logo.logo}
						</div>
