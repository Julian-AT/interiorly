      ...
      <div className="w-full">
        <div className="relative z-20 h-[400px] w-full overflow-hidden rounded-xl border border-border bg-secondary shadow-xl md:h-[400px]">
          <Image
            ...
            priority
          />
          <div className="-top-32 md:-top-40 absolute inset-0 flex flex-col items-center justify-center">
            <h1 className="max-w-xs text-center font-medium text-4xl text-white tracking-tighter md:max-w-2xl md:text-7xl">
              {ctaSection.title}
            </h1>
