...
export function NumberFlowCounter({
	...
	return (
		<div
			...
			} transition-opacity duration-300 ease-in-out absolute top-32 left-[50%] -translate-x-1/2 text-sm dark:bg-[#1A1B25] border dark:border-white/[0.07] border-blue-400 bg-blue-600 text-white px-4 py-1 rounded-full h-8 flex items-center justify-center font-mono shadow-[0px_1.1px_0px_0px_rgba(255,255,255,0.20)_inset,0px_4.4px_6.6px_0px_rgba(255,255,255,0.01)_inset,0px_2.2px_6.6px_0px_rgba(18,43,105,0.04),0px_1.1px_2.2px_0px_rgba(18,43,105,0.08),0px_0px_0px_1.1px_rgba(18,43,105,0.08)]`}
		>
			<NumberFlow
				value={currentValue}
				className="font-mono "
			...
			/>
			<span className="text-sm ml-2">Minutes Saved</span>
		</div>
	);
}
