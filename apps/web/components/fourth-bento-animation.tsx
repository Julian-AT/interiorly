...
const Notification = ({ name, description, icon, color, time }: Item) => {
	return (
		<figure
			className={cn(
				"relative w-3/4 mx-auto min-h-fit transform cursor-pointer overflow-hidden rounded-lg p-4",
				// animation styles
...
export function FourthBentoAnimation() {
	return (
		<div className="relative flex items-center justify-center overflow-hidden h-full w-full">
			<div className="pointer-events-none absolute top-0 left-0 h-1/2 w-full bg-gradient-to-b from-background to-transparent z-20" />
			<div className="pointer-events-none absolute bottom-0 left-0 h-1/2 w-full bg-gradient-to-t from-background to-transparent z-20" />
