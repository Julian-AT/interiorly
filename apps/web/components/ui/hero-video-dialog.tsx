      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button
                className="-top-16 absolute right-0 cursor-pointer rounded-full bg-neutral-900/50 p-2 text-white text-xl ring-1 backdrop-blur-md transition-all duration-200 ease-out hover:scale-[98%] dark:bg-neutral-100/50 dark:text-black"
                onClick={() => setIsVideoOpen(false)}
              >
